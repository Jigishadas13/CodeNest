      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            >
              <span className="block">CodeNest</span>
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              ...
              <p className="text-gray-600 dark:text-gray-300">
                This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our service that integrates with Google Calendar API and stores your competitive programming profiles.
              </p>
            </div>
