          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center">
              <div className="flex-shrink-0">
                <span className="text-2xl font-bold text-blue-600 dark:text-blue-400">CodeNest</span>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <motion.p
              ...
              variants={itemVariants}
            >
              CodeNest unifies your competitive coding profiles, tracks your progress, and keeps you updated on all upcoming contests across platforms - all in one place.
            </motion.p>
            <motion.div
      ...
      <footer className="bg-gray-900 text-gray-300 py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col items-center justify-center space-y-6">
            ...
            <div className="flex items-center space-x-4">
              <a
                href="https://github.com/Jigishadas13"
            ...
            <p className="text-sm text-gray-400">
              © 2025 Jigisha Das All rights reserved.
            </p>
          </div>
        </div>
      </footer>
